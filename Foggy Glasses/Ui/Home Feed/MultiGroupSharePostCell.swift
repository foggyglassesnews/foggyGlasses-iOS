...
class MultiGroupSharePostCell: SharePostCell{
    static let id2 = "Multi Group Share Post Cell Id"
...
extension MultiGroupSharePostCell: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
